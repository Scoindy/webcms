...
* Indigo
********************************************************************************
* Name          : fetch_filter_rules.php
* Description   : fetches rules for a given filter
...
*******************************************************************************/
  ...
  ****/
  $query  = "SELECT * FROM v_filter_rules WHERE filter_id = ";
  ...
  ****/
  ...
  file_put_contents( "/tmp/filter_rules.txt", $query);
