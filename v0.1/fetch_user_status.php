...
* Indio
********************************************************************************
* Name          : fetch_user_status.php
* Description   : fetches data to populate user_status grid
