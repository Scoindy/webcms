...
DROP TRIGGER IF EXISTS t_st_i;
CREATE TRIGGER t_st_i BEFORE INSERT ON segment_types
FOR EACH ROW 
SET NEW.created_by   = USER(),
    NEW.created_date = NOW();

DROP TRIGGER IF EXISTS t_st_u;
CREATE TRIGGER t_st_u BEFORE UPDATE ON segment_types
FOR EACH ROW 
