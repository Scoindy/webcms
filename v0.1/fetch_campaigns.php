...
*                                                                              *
********************************************************************************
* Name          : fetch_campaigns.php
* Description   : fetches data to populate campaigns grid
...
*******************************************************************************/
  ...
  ****/
  $query  = "SELECT * FROM v_campaigns ";

  /****
  *  Is there a status?
  ****/
  if(isset($_POST['status']) && $_POST['status'] != 'All') {
    $status   = $_POST['status']; // change to sanitize
    $query .=  "WHERE campaign_status LIKE '".$status."%'";
  }
